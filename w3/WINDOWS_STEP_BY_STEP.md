...
```text
w3/lab-closed-loop/dinhdanhnam/closed_loop.py
```
...
```text
w3/lab-closed-loop/dinhdanhnam/scripts/Start-Stack.ps1
w3/lab-closed-loop/dinhdanhnam/scripts/Stop-Stack.ps1
w3/lab-closed-loop/dinhdanhnam/scripts/Invoke-Fault.ps1
w3/lab-closed-loop/dinhdanhnam/scripts/Invoke-Traffic.ps1

w3/lab-closed-loop/dinhdanhnam/runbooks/restart_service.ps1
w3/lab-closed-loop/dinhdanhnam/runbooks/clear_cache.ps1
w3/lab-closed-loop/dinhdanhnam/runbooks/scale_replicas.ps1
w3/lab-closed-loop/dinhdanhnam/runbooks/multi_step_deploy.ps1
```
...
```powershell
python -m pip install -r w3/lab-closed-loop/dinhdanhnam/requirements.txt
```

### Step 2: Start the stack

```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File w3/lab-closed-loop/dinhdanhnam/scripts/Start-Stack.ps1
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File w3/lab-closed-loop/dinhdanhnam/scripts/Invoke-Traffic.ps1 -Service payment-svc -DurationSeconds 30
```

Inject Windows-compatible latency:

```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File w3/lab-closed-loop/dinhdanhnam/scripts/Invoke-Fault.ps1 latency payment-svc 900ms
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File w3/lab-closed-loop/dinhdanhnam/runbooks/restart_service.ps1 -Service payment-svc
```
...
```powershell
cd w3/lab-closed-loop/dinhdanhnam
...
```powershell
cd D:\Study\Home_work\xBrain\aiops-dinhdanhnam-AIO1
powershell -NoProfile -ExecutionPolicy Bypass -File w3/lab-closed-loop/dinhdanhnam/scripts/Invoke-Traffic.ps1 -Service payment-svc -DurationSeconds 240 -IntervalMilliseconds 200
powershell -NoProfile -ExecutionPolicy Bypass -File w3/lab-closed-loop/dinhdanhnam/scripts/Invoke-Fault.ps1 latency payment-svc 900ms
```
...
```text
w3/lab-mlops-lifecycle/dinhdanhnam/pipeline.py
w3/lab-mlops-lifecycle/dinhdanhnam/serve.py
w3/lab-mlops-lifecycle/dinhdanhnam/drift_detector.py
w3/lab-mlops-lifecycle/dinhdanhnam/retrain.py
```

### Windows scripts added

```text
w3/lab-mlops-lifecycle/dinhdanhnam/scripts/Start-Stack.ps1
w3/lab-mlops-lifecycle/dinhdanhnam/scripts/Stop-Stack.ps1
w3/lab-mlops-lifecycle/dinhdanhnam/scripts/Start-LocalMlflow.ps1
w3/lab-mlops-lifecycle/dinhdanhnam/scripts/Run-Pipeline.ps1
```
...
```powershell
python -m pip install -r w3/lab-mlops-lifecycle/dinhdanhnam/requirements.txt
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File w3/lab-mlops-lifecycle/dinhdanhnam/scripts/Start-Stack.ps1 -MlflowPort 5050
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File w3/lab-mlops-lifecycle/dinhdanhnam/scripts/Start-LocalMlflow.ps1 -Port 5052
```
...
```text
w3/lab-closed-loop/dinhdanhnam/DESIGN.md
w3/lab-closed-loop/dinhdanhnam/SUBMIT.md
w3/lab-mlops-lifecycle/dinhdanhnam/DESIGN.md
w3/lab-mlops-lifecycle/dinhdanhnam/SUBMIT.md
```
